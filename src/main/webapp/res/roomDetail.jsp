...
.nav a:hover, .header-actions a:hover, .header-actions button:hover {
	color: var(- -foreground);
}
...
.input-hint, .sidebar-label, .sidebar-value-small, .btn-note {
	font-size: 12px;
	color: var(- -muted-foreground);
}
...
.option-card.selected, .radio-card.selected {
	border-color: var(- -primary);
	background: rgba(37, 99, 235, 0.05);
}

.option-card-content, .radio-card-content {
	display: flex;
...
.option-header, .option-price-row, .price-row, .price-total-row,
	.sidebar-stay-info {
	display: flex;
	align-items: center;
	justify-content: space-between;
...
.sidebar-row i, .sidebar-stay-item i {
	color: var(- -primary);
}
...
.sidebar-date-value, .sidebar-date-time, .sidebar-stay-item {
	display: flex;
	align-items: center;
	gap: 6px;
}
...
@media ( max-width : 640px) {
	...
	.form-row, .form-row-3, .sidebar-dates {
	...
	<header class="header">
		<div class="header-container">
			<div class="header-content">
				...
				<nav class="nav">
					<a href="#">호텔 검색</a> <a
						href="${pageContext.request.contextPath}/res/reservationSearch.jsp">예약번호로
						확인</a> <a href="#">회원 서비스</a>
				</nav>

				<div class="header-actions">
					<a href="tel:+81-3-1234-5678"> <i data-lucide="phone"></i> <span>03-1234-5678</span>
					</a>
					<button type="button">
						<i data-lucide="globe"></i> <span>KR</span>
					</button>
				</div>
			</div>
		</div>
		...
		<div class="progress-bar">
			<div class="progress-bar-content">
				<span>호텔 선택</span> <span>→</span> <span>객실 선택</span> <span>→</span>
				<span class="active">예약 정보 입력</span> <span>→</span> <span>예약
					완료</span>
			</div>
		</div>
	</header>
		...
		<div class="main-content">
			<div class="form-section">
					...
					<div class="card-content">
						<div class="checkbox-wrapper" style="margin-bottom: 20px;">
							<input type="checkbox" id="sameAsBooker"
								onchange="handleSameAsBooker()"> <label
								for="sameAsBooker">예약자와 동일</label>
						</div>
						...
						<div class="form-group">
							...
							<input type="tel" id="guestPhone" name="guestPhone"
								form="paymentForm" placeholder="010-1234-5678">
					...
					<div class="card-content">
						...
						<div class="form-group">
							...
							<input type="email" id="bookerEmail" name="bookerEmail"
								form="paymentForm" placeholder="example@email.com">
						</div>

						<div class="form-group">
							<label for="bookerEmailConfirm">이메일 확인 <span
								class="required">*</span></label> <input type="email"
								id="bookerEmailConfirm" name="bookerEmailConfirm"
								form="paymentForm" placeholder="이메일 주소를 다시 입력해주세요">
						</div>

						<div class="form-row-3">
							<div class="form-group">
								<label for="postalCode">우편번호</label> <input type="text"
									id="postalCode" name="postalCode" form="paymentForm"
									placeholder="123-4567">
							</div>
							<div class="form-group">
								<label for="address">주소</label> <input type="text" id="address"
									name="address" form="paymentForm" placeholder="상세 주소를 입력해주세요">
							</div>
						</div>
					</div>
				</div>
							...
							<div class="option-card-content">
								...
								<div class="option-info">
									...
									<div class="option-price-row">
										<span class="option-unit-price">¥2,500 / 1인 1박</span> <span
											class="option-total-price" id="breakfast-total">+
											¥15,000</span>
									</div>
								</div>
							</div>
						...
						<button type="button" class="option-card" id="option-fastCheckin"
							...
							<div class="option-card-content">
								...
								<div class="option-info">
									...
									<div class="option-price-row">
										<span class="option-unit-price">¥1,000 / 1회</span> <span
											class="option-total-price">+ ¥1,000</span>
									</div>
								</div>
							</div>
						</button>
				...
				<div class="card">
					...
					<div class="card-content">
						<label class="radio-card selected" id="payment-card"
							onclick="selectPayment('card')"> <input type="radio"
							name="payment" value="card" checked form="paymentForm">
						...
						</label> <label class="radio-card" id="payment-onsite"
							onclick="selectPayment('onsite')"> <input type="radio"
							name="payment" value="onsite" form="paymentForm">
							<div class="radio-card-content">
								<div class="option-icon">
						...
						<div class="payment-note" id="payment-note" style="display: none;">
							현장 결제 시에는 카카오페이 결제창으로 이동하지 않습니다.</div>
					</div>
				</div>
					...
					<div class="card-content">
						...
						<div class="checkbox-wrapper">
							<input type="checkbox" id="agreeTerms"> <label
								for="agreeTerms">위 숙박약관 및 개인정보 처리방침에 동의합니다. <span
				...
				<div class="sidebar-inner">
						...
						<div class="sidebar-info">
							...
							<div class="sidebar-dates">
								<div>
									...
									<div class="sidebar-date-value">
										<i data-lucide="calendar"></i> <span>2025년 1월 15일</span>
									</div>
									<div class="sidebar-date-time">
										<i data-lucide="clock"></i> <span>15:00 ~</span>
									</div>
								</div>
								...
								<div>
									...
									<div class="sidebar-date-value">
										<i data-lucide="calendar"></i> <span>2025년 1월 17일</span>
									</div>
									<div class="sidebar-date-time">
										<i data-lucide="clock"></i> <span>~ 11:00</span>
									</div>
								</div>
							</div>
							...
							<div class="sidebar-stay-info">
								<div class="sidebar-stay-item">
									<i data-lucide="moon"></i> <span>2박</span>
								</div>
								<div class="sidebar-stay-item">
									<i data-lucide="users"></i> <span>성인 2명, 어린이 1명</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						<div class="card-content" style="padding-top: 20px;">
							...
							<div class="price-row">
								<span class="label">객실 요금 (2박)</span> <span>¥56,000</span>
							</div>

							<div class="price-row" id="price-breakfast"
								style="display: none;">
								<span class="label">조식 옵션</span> <span
									id="price-breakfast-value">¥15,000</span>
							</div>

							<div class="price-row" id="price-fastCheckin"
								style="display: none;">
								<span class="label">빠른 체크인</span> <span>¥1,000</span>
							</div>

							<div class="separator"></div>

							<div class="price-row">
								<span class="label">소계</span> <span id="subtotal">¥56,000</span>
							</div>

							<div class="price-row">
								<span class="label">세금 (10%)</span> <span id="tax">¥5,600</span>
							</div>

							<div class="separator"></div>

							<div class="price-total-row">
								<span class="label">합계 (세금 포함)</span> <span class="value"
									id="total">¥61,600</span>
							</div>

							<form id="paymentForm"
								action="${pageContext.request.contextPath}/reservationCreate"
								method="post" onsubmit="return handleReserve();">
								<input type="hidden" name="itemName" value="스탠다드 더블 예약금">
								<input type="hidden" name="quantity" value="1"> <input
									type="hidden" name="totalAmount" id="totalAmountInput"
									value="61600"> <input type="hidden"
									name="taxFreeAmount" value="0"> <input type="hidden"
									name="roomId" value="1"> <input type="hidden"
									name="checkInDate" value="2025-01-15"> <input
									type="hidden" name="checkOutDate" value="2025-01-17"> <input
									type="hidden" name="peopleCount" value="3">
